...
export function CheckoutForm() {
  ...
  const generateDiscordMessage = () => {
    ...
    return [
      ...
      '',
      `🚩 GANGUE: ${gangName}`,
      `🔐 CONTATO_1: ${secureContact || '[NÃO INFORMADO]'}`,
      `📞 CONTATO_2: ${contact2 || '[OPCIONAL]'}`,
      `📞 CONTATO_3: ${contact3 || '[OPCIONAL]'}`,
  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 mx-auto text-white mt-8">
      <div className="space-y-6">
        ...
        <Input
          placeholder="CONTATO DE SEGURANÇA (obrigatório)"
          value={secureContact}
        ...
        <Input
          placeholder="CONTATO DE SEGURANÇA 2 (opcional)"
          value={contact2}
        ...
        <Input
          placeholder="CONTATO DE SEGURANÇA 3 (opcional)"
          value={contact3}
        ...
        <Button
          ...
          disabled={isSubmitting || !secureContact || !isValidGang}
